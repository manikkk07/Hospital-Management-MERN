      ...
      <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
        ...
        <div>
          <div className="lg:w-[570px]">
            <h1 className="text-[36px] leading-[46px] text-heading font-[800] md:text-[60px] md:leading-[70px]">We help patients live a healthy, longer life.</h1>
            <p className="text__para">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Distinctio, voluptatum quibusdam. Inventore, laudantium.it necessitatibus obcaecati illum tenetur commodi excepturi magnam expedita dolorum perferendis consectetur, eveniet incidunt!</p>

            <button className="btn">Request an Appointment</button>
          </div>

          {/* {«««««« hero counter »»»»»»} */}
          <div className="mt-[30px] lg:mt-[70px] flex flex-col lg:flex-row lg:itmes-center gap-5 lg:gap-[30px]">

            <div>
                <h2 className="text-[36px] leading-[56px] lg:text-[44px] lg:leading-[54px] font-[700] text-heading">30+</h2>
                <span className="w-[100px] h-2 bg-yellow rounded-full block mt-[-14px]"></span>
              <p className="text__para">Years of Experience</p> 
            </div>

            <div>
                <h2 className="text-[36px] leading-[56px] lg:text-[44px] lg:leading-[54px] font-[700] text-heading">15+</h2>
                <span className="w-[100px] h-2 bg-purple rounded-full block mt-[-14px]"></span>
              <p className="text__para">Clinic Location</p> 
            </div>

            <div>
                <h2 className="text-[36px] leading-[56px] lg:text-[44px] lg:leading-[54px] font-[700] text-heading">100%</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]">
          ...
          <div className="py-[30px] px-5 ">
           ...
           <div className="mt-[30px]">
            ...
            <p className="text-[16px] leading-7 text-text font-[400] mt-4 text-center">World-class care for everyone. Our health System offers unmatched, expert health care. From the lab to the clinic.</p>
      ...
      <div className="flex items-center justify-between flex-col lg:flex-row">
        ...
        <div className="xl:w-[670px]">
          ...
          <ul className="pl-4">
            ...
            <li className="text__para">2. Search for your physician hero, and contact thier office.</li>
